...
import { OMNIDEF } from './testEditAccountEnglish_def.js';
import tmpl from './testEditAccountEnglish.html';
import tmpl_nds from './testEditAccountEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class testEditAccountEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
